...
class VITS(AbsGANSVS):
    ...
    def _forward_generator(
        ...
        p_hat = self.discriminator(singing_hat_, pred_pitch)
        with torch.no_grad():
            # do not store discriminator gradient in generator turn
            p = self.discriminator(singing_, gt_pitch)
    ...
    def _forward_discrminator(
        ...
        # parse outputs
        # remove dp loss
        singing_hat_, start_idxs, _, _, outs_ = outs
        (
            z,
            z2,
            z_p,
        ...
        # calculate discriminator outputs
        p_hat = self.discriminator(singing_hat_.detach(), pred_pitch.detach())
        p = self.discriminator(singing_, gt_pitch)
